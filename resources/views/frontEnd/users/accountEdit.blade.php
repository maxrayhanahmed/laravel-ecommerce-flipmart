...
<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 create-new-account">
    ...
    @if(Auth::user())
        ...
        <div class="form-group"> 
                ...
                <input id="lastName" type="lastName" class="form-control @error('lastName') is-invalid @enderror" name="lastName" value="{{Auth::user()->lastName}}" required autocomplete="lastName">
        ...
        <div class="form-group"> 
         ...
         <div class="form-group">
            <label class="info-title" for="address">Address </label>
             <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" placeholder="{{ __('Customer Address') }}" required autocomplete="address">
             	{{Auth::user()->address}}
             </textarea>
