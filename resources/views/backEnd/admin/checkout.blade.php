	    ...
	    <div class="panel-body">
			<div class="row">		
				...
				<div class="col-md-6 col-sm-6 already-registered-login">
					...
					<form action="{{ url('/checkout/store') }}" method="post" class="register-form" role="form">
						@csrf
					<div class="form-group">
					 ...
					 <div class="form-group">
					    ...
					    <input type="text" name="name" class="form-control unicase-form-control text-input" id="name" placeholder="">
					 </div>
